...
import os
import time
import pyAesCrypt                                                  # Функции для работы с операционной системой, не зависящие от используемой операционной системы
...
def send_email(addr_to, msg_subj, msg_text, files):
	addr_from = "saintjavatest@gmail.com"                           # Отправитель
	password  = "mwiicqrbyccpzgrx"                                   # Пароль
